...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleStorageUnavailable(StorageServiceUnavailableException exception) {
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                .body(new ApiError(Instant.now(), exception.getMessage()));
    }
