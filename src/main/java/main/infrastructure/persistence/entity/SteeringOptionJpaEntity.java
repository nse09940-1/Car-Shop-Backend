...
@Entity
@Table(name = "steering_options")
public class SteeringOptionJpaEntity extends BaseJpaEntity {
    ...
    @CollectionTable(name = "steering_option_compatible_model_codes", joinColumns = @JoinColumn(name = "option_id"))
